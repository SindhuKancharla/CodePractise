...
public class GetAllImpValues extends SentenceExtraction{
	...
	static String stanbolOPFile = "";
	protected static File cleanTextOP;
	protected static File inputTxtFile ;
	...
	public static void getEntities(String inputFileName, String fileType){
		...
		if(server){
			...
			inputTxtFile = new File("/var/www/gen/InputTextFile.txt");
	     	stanbolOPFile = "/var/www/gen/stanbolentities.txt";
	...
	//		impSentsOPFile = "/var/www/gen/impSentsOutput.txt";
	    	...
	    	props.setProperty("gate.home", "/media/224A33054A32D56F/gate/");
	        props.setProperty("gate.plugins.home", "/media/224A33054A32D56F/gate/plugins/");
