...
public class GetDocumentDateHTML {
	...
	public static void main(String[] args) throws IOException, SAXException{
		...
		if(server){
			...
			resourcesPath = "/var/www/html/gen/";
			cleanTextOP = new File("/var/www/html/gen/cleanText.txt");
			cleanHTMLOP = new File("/var/www/html/gen/cleanHTML.html");

	     	Properties props = System.getProperties();
		
	     	props.setProperty("gate.home", "/home/sindhuja/gate");
	     	props.setProperty("gate.plugins.home", "/home/sindhuja/GatePlugins");
	     	props.setProperty("gate.site.config", "/home/sindhuja/gate.xml");
	     	...
	     	fileName = "/var/www/html/gen/"+args[0];
			actualFileName = args[1];

			outputFile = "/var/www/html/gen/DocumentDate.txt";
		}
