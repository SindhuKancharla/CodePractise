...
public class GetControllerForEntityExtractionPDF extends SentenceExtraction{
...
//		 controller.add(6,zem);
		...
		params.put("grammarURL", new File(resourcesPath+"resources/features.extraction.pdf/MainGetFeaturesPDF.jape").toURI().toURL()); 
